...
GitHub tickboxes are preserved (only for `yarn` objects)
...
function (for those using the output of
...
3.  If you use a postfix dollar sign in your prose (e.g. BASIC commands
    ...
    #> ℹ HINT: If you are writing BASIC code, make sure you wrap variable names and
    #>   code in backtics like so: `INKEY$`
